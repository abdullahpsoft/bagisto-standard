...
<head>
    ...
    <title>Sellers Registration Elite Shoping </title>
    <meta content="" name="descriptison">
    <meta content="" name="keywords">

    <!-- Favicons -->
    <link href="seller/assets/img/favicon.png" rel="icon">
    <link href="seller/assets/img/apple-touch-icon.png" rel="apple-touch-icon">

    <!-- Google Fonts -->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Raleway:300,300i,400,400i,500,500i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">

    <!-- Vendor CSS Files -->
    <link href="seller/assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link href="seller/assets/vendor/icofont/icofont.min.css" rel="stylesheet">
    <link href="seller/assets/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
    <link href="seller/assets/vendor/owl.carousel/assets/owl.carousel.min.css" rel="stylesheet">
    <link href="seller/assets/vendor/venobox/venobox.css" rel="stylesheet">
    <link href="seller/assets/vendor/aos/aos.css" rel="stylesheet">

    <!-- Template Main CSS File -->
    <link href="seller/assets/css/style.css" rel="stylesheet">
...
{{--                    <a href="#" class="download-btn"><i class="bx bxl-apple"></i> App Store</a>--}}
            ...
            <div class="col-lg-6 d-lg-flex flex-lg-column align-items-stretch order-1 order-lg-2 hero-img" data-aos="fade-up">
                <img src="seller/assets/img/hero-img.png" class="img-fluid" alt="">
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row no-gutters">
                ...
                <div class="image col-xl-5 d-flex align-items-stretch justify-content-center order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
                    <img src="seller/assets/img/features.svg" class="img-fluid" alt="">
                </div>
            </div>
...
<!-- Vendor JS Files -->
<script src="seller/assets/vendor/jquery/jquery.min.js"></script>
<script src="seller/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
<script src="seller/assets/vendor/jquery.easing/jquery.easing.min.js"></script>
<script src="seller/assets/vendor/php-email-form/validate.js"></script>
<script src="seller/assets/vendor/owl.carousel/owl.carousel.min.js"></script>
<script src="seller/assets/vendor/venobox/venobox.min.js"></script>
<script src="seller/assets/vendor/aos/aos.js"></script>

<!-- Template Main JS File -->
<script src="seller/assets/js/main.js"></script>
